...
export default function HomeV2() {
  return (
    <div className="theme-v2 min-h-screen selection:bg-brand-primary selection:text-white">
      {/* Navigation */}
      ...
      <footer className="py-12 border-t border-white/5 bg-dark-bg">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <p className="text-white/30 text-sm">© 2026. Todos os direitos reservados.</p>
